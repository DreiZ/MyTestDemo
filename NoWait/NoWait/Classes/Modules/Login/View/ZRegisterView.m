...
- (UITextField *)messageCodeTF {
    if (!_messageCodeTF ) {
        ...
        [_messageCodeTF setFont:[UIFont fontContent]];
        ...
        _messageCodeTF.textColor = adaptAndDarkColor([UIColor colorTextBlack], [UIColor colorTextBlackDark]);
    }
...
- (UIButton *)getCodeBtn {
    if (!_getCodeBtn) {
        ...
        [_getCodeBtn.titleLabel setFont:[UIFont fontSmall]];
    }
    return _getCodeBtn;
}
