//
//  ZAlertStoresTeacherCheckBoxView.m
//  NoWait
//
...
@interface ZAlertStoresTeacherCheckBoxView()
@property (nonatomic,assign) NSInteger currentPage;
@property (nonatomic,strong) NSMutableArray *dataSources;

@end
@implementation ZAlertStoresTeacherCheckBoxView

static ZAlertStoresTeacherCheckBoxView *sharedTeacherManager;

+ (ZAlertStoresTeacherCheckBoxView *)sharedTeacherManager {
    @synchronized (self) {
        if (!sharedTeacherManager) {
            sharedTeacherManager = [[ZAlertStoresTeacherCheckBoxView alloc] init];
        }
    }
...
-(void)setName:(NSString *)title stores_id:(NSString *)stores_id handlerBlock:(void (^)(NSInteger,id))handleBlock {
...
+ (void)setAlertName:(NSString *)title stores_id:(NSString *)stores_id handlerBlock:(void(^)(NSInteger,id))handleBlock {
    [[ZAlertStoresTeacherCheckBoxView sharedTeacherManager] setName:title stores_id:stores_id handlerBlock:handleBlock];
}
