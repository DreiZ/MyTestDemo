...
- (void)setModel:(ZLocationModel *)model {
    ...
    self.subTitleLabel.text = model.businessArea;
//    [NSString stringWithFormat:@"%@%@%@%@",model.province,model.city,model.district,model.address];
    if (model.isSelected) {
...
+(CGFloat)z_getCellHeight:(id)sender {
    ...
    CGSize tempSize = [[NSString stringWithFormat:@"%@",model.address] tt_sizeWithFont:[UIFont fontSmall] constrainedToWidth:KScreenWidth - CGFloatIn750(86)];
