...
- (ZAddClassCodeView *)codeImageView {
    if (!_codeImageView) {
        ...
        _codeImageView = [[ZAddClassCodeView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth-CGFloatIn750(60), CGFloatIn750(180) + CGFloatIn750(792) + CGFloatIn750(120) - CGFloatIn750(70))];
