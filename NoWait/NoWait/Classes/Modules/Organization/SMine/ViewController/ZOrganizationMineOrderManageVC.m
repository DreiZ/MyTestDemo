//
//  ZOrganizationMineOrderManageVC.m
//  NoWait
//
...
@implementation ZOrganizationMineOrderManageVC
...
- (NSMutableArray *)titleArr {
    if (!_titleArr) {
        _titleArr = @[@"全部", @"待支付", @"待接受", @"已完成"].mutableCopy;
    }
    return _titleArr;
}
        ...
        for (int i = 0; i < self.titleArr.count; i++) {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    lvc.type = ZOrganizationOrderTypeHadEva;
                    break;
