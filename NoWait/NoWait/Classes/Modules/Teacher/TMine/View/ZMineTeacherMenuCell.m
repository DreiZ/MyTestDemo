...
#import "ZMineTeacherMenuCell.h"
#import "ZStudentMainPhotoWallItemCell.h"

@interface ZMineTeacherMenuCell ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation ZMineTeacherMenuCell
...
- (UICollectionView *)iCollectionView {
    if (!_iCollectionView) {
        ...
        _iCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, [ZMineTeacherMenuCell z_getCellHeight:nil]) collectionViewLayout:flowLayout];
