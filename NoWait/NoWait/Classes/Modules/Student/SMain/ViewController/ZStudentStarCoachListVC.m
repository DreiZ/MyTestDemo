...
@implementation ZStudentStarCoachListVC
...
- (UICollectionView *)iCollectionView {
    if (!_iCollectionView) {
        ...
        _iCollectionView.backgroundColor = adaptAndDarkColor([UIColor colorGrayBG], [UIColor colorBlackBG]);
