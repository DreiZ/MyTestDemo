//
//  ZStudentOrganizationDetailQualificationVC.m
//  NoWait
//
...
@interface ZStudentOrganizationDetailQualificationVC ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic,strong) UITableView *iTableView;

@property (nonatomic,strong) NSMutableArray *dataSources;
@property (nonatomic,strong) NSMutableArray *cellConfigArr;
@end
@implementation ZStudentOrganizationDetailQualificationVC
