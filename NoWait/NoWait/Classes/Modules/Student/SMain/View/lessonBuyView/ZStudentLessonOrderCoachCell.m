...
- (UILabel *)adeptLabel {
    if (!_adeptLabel) {
        ...
        _adeptLabel.textColor = adaptAndDarkColor([UIColor colorTextBlack], [UIColor colorTextBlackDark]);
        _adeptLabel.text = @"";
...
- (UILabel *)desLabel {
    if (!_desLabel) {
        ...
        _desLabel.textColor = adaptAndDarkColor([UIColor colorTextBlack], [UIColor colorTextBlackDark]);
        _desLabel.text = @"";
