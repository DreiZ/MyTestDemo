...
- (void)setupView {
    self.contentView.backgroundColor = KAdaptAndDarkColor(KBackColor,K1aBackColor);
...
- (UIView *)funBackView {
    if (!_funBackView) {
        ...
        _funBackView.backgroundColor = KAdaptAndDarkColor(KBackColor,K1aBackColor);
    }
    return _funBackView;
}
...
- (UICollectionView *)iCollectionView {
    if (!_iCollectionView) {
        ...
        _iCollectionView.backgroundColor = KAdaptAndDarkColor(KBackColor,K1aBackColor);
