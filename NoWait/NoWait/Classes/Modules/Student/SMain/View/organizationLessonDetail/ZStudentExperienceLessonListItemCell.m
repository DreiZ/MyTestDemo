//
//  ZStudentExperienceLessonListItemCell.m
//  NoWait
//
...
@interface ZStudentExperienceLessonListItemCell ()
...
@implementation ZStudentExperienceLessonListItemCell
...
- (void)setModel:(ZOriganizationLessonListModel *)model {
    ...
    _favourablePriceLabel.text = [NSString stringWithFormat:@"￥%@",model.experience_price];
    _priceLabel.text = [NSString stringWithFormat:@"￥%@",model.experience_price];
}

+(CGSize)z_getCellSize:(id)sender {
    return CGSizeMake((KScreenWidth-CGFloatIn750(90))/2, 165/165 * (KScreenWidth-CGFloatIn750(90))/2 + CGFloatIn750(10));
}
@end
