...
- (UIView *)contBackView {
    if (!_contBackView) {
        ...
        _contBackView.backgroundColor = adaptAndDarkColor([UIColor colorWhite], [UIColor colorBlackDarkBG]);
...
- (UILabel *)skillLabel {
    if (!_skillLabel) {
        ...
        _skillLabel.textColor = adaptAndDarkColor([UIColor colorWhite], [UIColor colorBlackDarkBG]);
