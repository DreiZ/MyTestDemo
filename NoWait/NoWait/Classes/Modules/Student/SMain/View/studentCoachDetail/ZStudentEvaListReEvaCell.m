...
-(void)setupView {
    ...
    [self.contView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.contentView.mas_left).offset(CGFloatIn750(86));
...
+(CGFloat)z_getCellHeight:(id)sender {
    ...
    CGSize tsize = [eva tt_sizeWithFont:[UIFont fontContent] constrainedToSize:CGSizeMake(KScreenWidth - CGFloatIn750(162), MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping lineSpace:CGFloatIn750(10)];
