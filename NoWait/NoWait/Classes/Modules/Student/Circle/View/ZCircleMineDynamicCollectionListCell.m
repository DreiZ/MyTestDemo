//
//  ZCircleMineDynamicCollectionListCell.m
//  NoWait
//
...
@interface ZCircleMineDynamicCollectionListCell ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation ZCircleMineDynamicCollectionListCell
...
+(CGSize)z_getCellSize:(id)sender {
    ...
    CGFloat height = 0;
    if (list.count%2 > 0) {
        height = (list.count/2 + 1) * [ZCircleMineDynamicCollectionCell z_getCellSize:nil].height + ((list.count/2) * CGFloatIn750(4))+ CGFloatIn750(40);
    }else{
        height = list.count/2  * [ZCircleMineDynamicCollectionCell z_getCellSize:nil].height + (list.count/2 - 1)  * CGFloatIn750(4) + CGFloatIn750(40);
    }
