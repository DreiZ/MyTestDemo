//
//  ZStudentMineOrderSubscribeListVC.m
//  NoWait
//
...
@interface ZStudentMineOrderSubscribeListVC ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic,strong) UITableView *iTableView;

@property (nonatomic,strong) NSMutableArray *dataSources;
@property (nonatomic,strong) NSMutableArray *cellConfigArr;
@end
@implementation ZStudentMineOrderSubscribeListVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cellConfig.title isEqualToString:@"ZStudentMineOrderListCell"]){
        ...
        enteryCell.handleBlock = ^(ZLessonOrderHandleType type) {
            if (type == ZLessonOrderHandleTypeDetail) {
