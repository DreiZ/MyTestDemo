...
- (UILabel *)orderStateLabel {
    if (!_orderStateLabel) {
        ...
        _orderStateLabel.textColor = KFont3Color;
...
- (void)setData {
    ...
    ZCellConfig *topCellConfig = [ZCellConfig cellConfigWithClassName:[ZSpaceEmptyCell className] title:[ZSpaceEmptyCell className] showInfoMethod:@selector(setBackColor:) heightOfCell:CGFloatIn750(96) cellType:ZCellTypeClass dataModel:KWhiteColor];
...
//
    ...
    ZCellConfig *bottomCellConfig = [ZCellConfig cellConfigWithClassName:[ZSpaceEmptyCell className] title:[ZSpaceEmptyCell className] showInfoMethod:@selector(setBackColor:) heightOfCell:CGFloatIn750(20) cellType:ZCellTypeClass dataModel:KWhiteColor];
