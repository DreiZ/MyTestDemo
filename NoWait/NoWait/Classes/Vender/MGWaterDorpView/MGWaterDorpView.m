...
static CGFloat amplitude_span = 46.0;//波幅可调节幅度
...
// 前景色
#define heavyColor [UIColor colorWithRed:1 green:1 blue:1 alpha:0.3]
// 后面色
#define lightColor [UIColor colorWithRed:1 green:1 blue:1 alpha:1]
...
- (void)drawWaveWaterWithOriginX:(double)originX fillColor:(UIColor *)fillColor
{
    ...
    int tempValue = [self roundingWithCount:(2 * cycle) * 4];
...
- (void)setupShapeLayer
{
    ...
    lineChartLayer.strokeColor = [UIColor colorWithHexString:@"FF8854"].CGColor;
