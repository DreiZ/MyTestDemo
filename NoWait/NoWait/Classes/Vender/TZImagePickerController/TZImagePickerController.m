...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorMain];
    self.oKButtonTitleColorDisabled = [UIColor colorMainSub];
    
    self.navigationBar.barTintColor = adaptAndDarkColor([UIColor colorTextBlack], [UIColor colorTextBlackDark]);
