...
+ (BAURLSessionTask *)ba_requestWithType:(BAHttpRequestType)type
    ...
    if (type == BAHttpRequestTypeGet) {
        sessionTask = [BANetManagerShare.sessionManager GET:URLString parameters:entity.parameters progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        sessionTask = [BANetManagerShare.sessionManager POST:URLString parameters:entity.parameters progress:^(NSProgress * _Nonnull uploadProgress) {
            if (BANetManagerShare.isOpenLog) {
        ...
        sessionTask = [BANetManagerShare.sessionManager PUT:URLString parameters:entity.parameters success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        sessionTask = [BANetManagerShare.sessionManager DELETE:URLString parameters:entity.parameters success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
            if (successBlock) {
                successBlock(responseObject);
            }
