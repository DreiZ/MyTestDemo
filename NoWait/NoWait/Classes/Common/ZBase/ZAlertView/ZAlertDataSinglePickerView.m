...
@interface ZAlertDataSinglePickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation ZAlertDataSinglePickerView

static ZAlertDataSinglePickerView *sharedManager;

+ (ZAlertDataSinglePickerView *)sharedManager {
    @synchronized (self) {
        if (!sharedManager) {
            sharedManager = [[ZAlertDataSinglePickerView alloc] init];
        }
    }
