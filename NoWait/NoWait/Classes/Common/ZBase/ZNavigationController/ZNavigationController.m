...
+ (void)initialize
{
    ...
    navBar.backIndicatorImage = isDarkModel() ? [UIImage imageNamed:@"navleftBackDark"] : [UIImage imageNamed:@"navleftBack"];
    navBar.backIndicatorTransitionMaskImage = isDarkModel() ? [UIImage imageNamed:@"navleftBackDark"] : [UIImage imageNamed:@"navleftBack"];
...
-(void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if ([viewController isKindOfClass:[ZViewController class]]) {
        ZViewController * vc = (ZViewController *)viewController;
...
//    else if ([viewController isKindOfClass:[ZInfomationMainViewController class]]) {
//        ZInfomationMainViewController * vc = (ZInfomationMainViewController *)viewController;
//        if (vc.isHidenNaviBar) {
//            vc.view.top = 0;
//            [vc.navigationController setNavigationBarHidden:YES animated:animated];
//        }else{
